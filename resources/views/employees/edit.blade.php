          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create new employee</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('employees.update',$employee->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="first_name" value="{{ $employee->first_name }}" class="form-control" id="first_name" placeholder="Enter first name">first_name
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" name="email" value="{{ $employee->email }}" class="form-control" id="email" placeholder="Enter email">
                  </div>
